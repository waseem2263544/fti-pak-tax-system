        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('wealth.movements.store', [$client, $line]) }}" class="row g-2 align-items-end mt-3">
                        @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <button class="btn btn-accent btn-sm w-100">Record</button>
                        </div>
                        <div class="col-12">
