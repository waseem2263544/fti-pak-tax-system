...
<div class="d-flex justify-content-between align-items-center mb-4">
    <p style="color: var(--n-400); font-size: 0.85rem; margin: 0;">Auto-create tasks for clients based on their active services on a schedule.</p>
        ...
        <div class="d-flex justify-content-between align-items-start">
            <div class="d-flex align-items-start gap-3">
                ...
                <div>
                    ...
                    <div style="font-size: 0.8rem; color: var(--n-500); margin-top: 2px;">
                    ...
                    @if($auto->description)
                    <div style="font-size: 0.8rem; color: var(--n-500); margin-top: 4px;">{{ $auto->description }}</div>
                    @endif
                </div>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="badge" style="background: {{ $auto->is_active ? 'var(--ok-tint)' : 'var(--n-50)' }}; color: {{ $auto->is_active ? 'var(--ok-ink)' : 'var(--n-400)' }}; min-width: 55px;">
...
<div class="card">
    <div class="card-body text-center py-5">
        <i class="bi bi-clock-history" style="font-size: 3rem; color: var(--n-150);"></i>
        <h5 class="mt-3" style="color: var(--primary); font-weight: 700;">No scheduled tasks yet</h5>
        <p style="color: var(--n-400); font-size: 0.85rem; max-width: 400px; margin: 0 auto 16px;">
