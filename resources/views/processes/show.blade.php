...
<div class="card mt-4">
    <div class="card-body" style="padding: 18px; display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('processes.document.combined-pdf', $process) }}?download=1" class="btn btn-accent"><i class="bi bi-download me-1"></i>Download</a>
        </div>
    </div>
</div>
...
<div class="card mt-4">
    ...
    <div class="card-body" style="padding: 20px;">
        ...
        @php
            ...
            $docCards = [
                ['key' => 'index',             'name' => 'Index',             'desc' => $isStTribunalStay ? 'Index of all documents' : 'Print 4× and tick the copy type', 'icon' => 'bi-list-columns-reverse', 'color' => '#22262e', 'bg' => '#eef0f4'],
                ['key' => 'appeal-memo',       'name' => 'Appeal Memo',       'desc' => 'Memorandum of appeal (Form B)',                              'icon' => 'bi-file-earmark-ruled',   'color' => '#dc2626', 'bg' => 'var(--danger-tint)'],
