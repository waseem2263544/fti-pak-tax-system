        ...
        <div class="card-body" style="padding: 24px;">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="commissioner_appeals" class="form-control" value="{{ old('commissioner_appeals', $meta['commissioner_appeals'] ?? '') }}" placeholder="e.g. Mr. Ahmed Khan, Commissioner Inland Revenue (Appeals), Peshawar">
            ...
            @if(in_array($template, ['st-tribunal-stay', 'st-tribunal-stay-extension'], true))
            @php
                $rcvNo = old('recovery_notice_no', $meta['recovery_notice_no'] ?? '') ?: '_______________';
                $rcvDateRaw = old('recovery_notice_date', $meta['recovery_notice_date'] ?? '');
                ...
                $resp1 = old('respondent_1', $meta['respondent_1'] ?? '') ?: 'The Commissioner Inland Revenue';
            ...
            <div class="mb-3">
                ...
                <div id="stayapp-editor" contenteditable="true" class="form-control" style="min-height: 120px; max-height: 360px; overflow-y: auto; white-space: pre-wrap; line-height: 1.7;">{!! old('stay_application_body', ($meta['stay_application_body'] ?? '') ?: $defaultStayBody) !!}</div>
