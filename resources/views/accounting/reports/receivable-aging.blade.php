...
@section('page-title', 'Receivable Aging')
...
<div class="card mb-4 no-print">
    <div class="card-body" style="padding: 16px 20px;">
        <form method="GET" action="{{ route('accounting.reports.receivable-aging') }}">
...
<div class="card mb-4">
    <div class="card-body" style="padding: 32px; text-align: center;">
        ...
        <h5 style="font-weight: 600; color: var(--primary); margin: 8px 0 4px;">Accounts Receivable Aging</h5>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            <div style="width: 28px; height: 28px; background: rgba(48,58,80,0.06); border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.6rem; color: var(--primary);">{{ strtoupper(substr($row['client_name'] ?? '', 0, 2)) }}</div>
                            <span style="font-size: 0.85rem; font-weight: 600; color: var(--primary);">{{ $row['client_name'] ?? '-' }}</span>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5" style="color: #9ca3af;">
                        ...
                        No receivable aging data found.
                    </td>
                </tr>
                @endforelse
