...
<form action="{{ route('accounting.sales-invoices.store') }}" method="POST" id="invoice-form">
    @csrf
        ...
        <div class="card-body" style="padding: 24px;">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('reference') is-invalid @enderror" name="reference" value="{{ old('reference') }}" placeholder="PO number, contract ref...">
            ...
            <div class="card mb-4">
                <div class="card-body" style="padding: 20px;">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="notes" rows="3" placeholder="Notes visible on the invoice...">{{ old('notes') }}</textarea>
                    </div>
                    <div>
                        <label class="form-label">Terms &amp; Conditions</label>
                        <textarea class="form-control" name="terms" rows="3" placeholder="Payment terms, late fees, etc...">{{ old('terms') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
