...
<form action="{{ route('accounting.sales-invoices.update', $invoice) }}" method="POST" id="invoice-form">
    @csrf
    @method('PUT')
        ...
        <div class="card-body" style="padding: 24px;">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select searchable @error('client_id') is-invalid @enderror" name="client_id" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" class="form-control @error('due_date') is-invalid @enderror" name="due_date" value="{{ old('due_date', $invoice->due_date->format('Y-m-d')) }}" required>
                    @error('due_date') <span class="invalid-feedback">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Reference</label>
                    <input type="text" class="form-control @error('reference') is-invalid @enderror" name="reference" value="{{ old('reference', $invoice->reference) }}" placeholder="PO number, contract ref...">
                ...
                <div class="card-body" style="padding: 20px;">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3" style="padding-bottom: 12px; border-bottom: 1px solid #f0f2f5;">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="discount" id="discount-input" value="{{ old('discount', $invoice->discount ?? 0) }}" step="0.01" min="0" style="width: 100px;" oninput="calculateTotals()">
                        </div>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('accounting.sales-invoices.index') }}" class="btn btn-outline-primary">Cancel</a>
    </div>
</form>
@endsection
