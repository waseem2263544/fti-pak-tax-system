    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-body" style="padding: 32px;">
                ...
                <p style="color: var(--n-600); font-size: 0.9rem; line-height: 1.7; margin-bottom: 24px;">
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.82rem; color: var(--n-500);">Click "Download Extension" above. Extract the ZIP file to a folder on your computer.</div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.82rem; color: var(--n-500);">Go to <code style="background: var(--n-50); padding: 2px 6px; border-radius: 4px;">chrome://extensions</code> in your browser. Enable <strong>"Developer mode"</strong> (top right toggle).</div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.82rem; color: var(--n-500);">Click <strong>"Load unpacked"</strong>. Select the <code style="background: var(--n-50); padding: 2px 6px; border-radius: 4px;">chrome-extension</code> folder from the extracted ZIP.</div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.82rem; color: var(--n-500);">Pin the extension to your toolbar. Click it and login with your FairTax app email and password.</div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.82rem; color: var(--n-500);">Visit iris.fbr.gov.pk, kpra.kp.gov.pk, or leap.secp.gov.pk. Click the extension, search for a client, and hit <strong>"Fill"</strong>.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-5">
        <div class="card mb-4">
            ...
            <div class="card-body" style="padding: 20px;">
                <div class="mb-2" style="font-size: 0.85rem; color: var(--n-600);">
                    <i class="bi bi-check-circle-fill me-2" style="color: var(--ok);"></i>Credentials are <strong>never stored</strong> in the browser
                </div>
                <div class="mb-2" style="font-size: 0.85rem; color: var(--n-600);">
                    <i class="bi bi-check-circle-fill me-2" style="color: var(--ok);"></i>Fetched from server on demand via <strong>encrypted HTTPS</strong>
                </div>
                <div class="mb-2" style="font-size: 0.85rem; color: var(--n-600);">
                    <i class="bi bi-check-circle-fill me-2" style="color: var(--ok);"></i>Requires <strong>employee login</strong> to access
                </div>
                <div class="mb-2" style="font-size: 0.85rem; color: var(--n-600);">
                    <i class="bi bi-check-circle-fill me-2" style="color: var(--ok);"></i>Token expires after <strong>12 hours</strong>
                </div>
                <div style="font-size: 0.85rem; color: var(--n-600);">
                    <i class="bi bi-check-circle-fill me-2" style="color: var(--ok);"></i>Only works on <strong>FBR, KPRA, SECP</strong> portals
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="d-flex align-items-center gap-3 px-4 py-3" style="border-bottom: 1px solid var(--n-50);">
                    <span class="badge" style="background: var(--info-tint); color: var(--info-ink);">FBR</span>
                    <span style="font-size: 0.85rem;">iris.fbr.gov.pk</span>
                </div>
                <div class="d-flex align-items-center gap-3 px-4 py-3" style="border-bottom: 1px solid var(--n-50);">
                    <span class="badge" style="background: var(--ok-tint); color: var(--ok-ink);">KPRA</span>
                    <span style="font-size: 0.85rem;">kpra.kp.gov.pk</span>
                </div>
                <div class="d-flex align-items-center gap-3 px-4 py-3">
                    <span class="badge" style="background: var(--warn-tint); color: var(--warn-ink);">SECP</span>
