...
// ── Find the directory ──
echo "── Searching ──\n";
$home = dirname(__DIR__, 2);           // typically /home/<account>
$roots = array_unique([$home, dirname(__DIR__), '/home']);
$found = null;

foreach ($roots as $root) {
    if (!is_dir($root)) continue;

    // Bounded walk: challan dirs sit at <docroot>/uploads/challans
    ...
    foreach ($it as $path => $info) {
        ...
        if (basename($path) !== 'challans') continue;
        ...
        echo "  (found $path but it does not hold the referenced files)\n";
    }
}
